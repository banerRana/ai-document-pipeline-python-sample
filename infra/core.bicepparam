...
param resourceGroupName = readEnvironmentVariable('AZURE_RESOURCE_GROUP_NAME',workloadName)
...
param vmUserInitialPassword = concat(uniqueString(principalId, workloadName, 'password'), '@123')
